...
# Ограничения и параметры обработки фотографий портфолио.
PORTFOLIO_IMAGE_MAX_UPLOAD_SIZE = 20 * 1024 * 1024  # 20 МиБ
PORTFOLIO_IMAGE_MAX_SOURCE_SIDE = 16_000
PORTFOLIO_IMAGE_MAX_SOURCE_PIXELS = 80_000_000
PORTFOLIO_IMAGE_MAX_OUTPUT_SIDE = 2_560
PORTFOLIO_IMAGE_WEBP_QUALITY = 82
